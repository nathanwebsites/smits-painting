        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" aria-label="Facebook" className="w-9 h-9 rounded-full bg-[#1A0E06] flex items-center justify-center text-[#C4A882] hover:bg-[#8B5A2B] hover:text-white transition-all duration-200">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="w-9 h-9 rounded-full bg-[#1A0E06] flex items-center justify-center text-[#C4A882] hover:bg-[#8B5A2B] hover:text-white transition-all duration-200">
              ...
              <a href="#" aria-label="WhatsApp" className="w-9 h-9 rounded-full bg-[#1A0E06] flex items-center justify-center text-[#C4A882] hover:bg-[#8B5A2B] hover:text-white transition-all duration-200">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
